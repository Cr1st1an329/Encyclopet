...
<!--- Main CSS -->
<link href="FuncionesAdicionales/CartasCristal/styleGatos.css" rel="stylesheet">
...
<img class="card-img-top" src="./imgGatos/<?php echo$Gato['imagen']; ?>" alt="" >
<div class="card-body">
    <h4 class="card-title mb-4"><?php echo $Gato['raza']; ?> </h4>
    <p class="card-text"><?php echo $Gato['informacion']; ?></p>
